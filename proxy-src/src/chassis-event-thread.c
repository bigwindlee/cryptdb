...
/**
 * SECTION:chassis-event-thread
 * @short_description: event-threads
 *
 * event threads allow the spread execution of events over several threads
 */
...
/**
 * chassis_event_op_free:
 * @e: a #chassis_event_op_t
 *
 * free a event-op
 */
void
chassis_event_op_free(chassis_event_op_t *e) {
	if (!e) return;
...
/**
 * chassis_event_op_apply:
 * @op: a #chassis_event_op_t
 * @event_base: a event-base
 *
 ...
 */
void
chassis_event_op_apply(chassis_event_op_t *op, struct event_base *event_base) {
	switch (op->type) {
...
/**
 * chassis_event_add_with_timeout:
 * @chas: chassis
 * @ev: event
 * @tv: timeout
 *
...
/**
 * chassis_event_add_local_with_timeout:
 * @chas: chassis
 * @ev: a event
 * @tv: timeout
 *
 ...
 */
void
chassis_event_add_local_with_timeout(chassis G_GNUC_UNUSED *chas, struct event *ev, struct timeval *tv) {
...
/**
 * chassis_event_add_local:
 * @chas: chjassis
 * @ev: event
 *
 * add a event to the current thread with a initite timeout
 */
void
chassis_event_add_local(chassis *chas, struct event *ev) {
 ...
 * @event_fd: event fd
 * @events: event type
 * @user_data: (type chassis_event_thread_t): userdata
 *
 ...
 */
void
chassis_event_handle(int G_GNUC_UNUSED event_fd, short G_GNUC_UNUSED events, void *user_data) {
 ...
 *
 * Returns: chassis_event_thread_new()
 */
 ...
 * @event_thread: a #chassis_event_thread_t
 *
 ...
 */
void
chassis_event_thread_free(chassis_event_thread_t *event_thread) {
 ...
 */
void
chassis_event_thread_set_event_base(chassis_event_thread_t G_GNUC_UNUSED *e, struct event_base *event_base) {
	g_private_set(tls_event_base_key, event_base);
}

/**
 * chassis_event_threads_new:
 *
 ...
 *
 * Returns: a #chassis_event_threads_t
 */
...
/**
 * chassis_event_threads_free:
 * @threads: a #chassis_event_threads_t
 *
 ...
 */
void
chassis_event_threads_free(chassis_event_threads_t *threads) {
	guint i;
	chassis_event_op_t *op;
 ...
 * @threads: a #chassis_event_threads_t
 * @thread: a #chassis_event_thread_t
 *
 * add a event-thread to the event-threads handler
 */
void
chassis_event_threads_add(chassis_event_threads_t *threads, chassis_event_thread_t *thread) {
 ...
 */
void *
chassis_event_thread_loop(chassis_event_thread_t *event_thread) {
 ...
 */
void
chassis_event_threads_start(chassis_event_threads_t *threads) {
	guint i;
