...
/**
 * SECTION:network-mysqld-packet
 * @short_description: codecs for the MySQL client protocol
 *
 * mid-level protocol 
 *
 ...
 *
 * create a new #network_mysqld_com_query_result_t
 */
 ...
 * @udata: a #network_mysqld_com_query_result_t
 *
 * free a #network_mysqld_com_query_result_t
 */
void
 ...
 * @udata: unused
 *
 * calling this function results in a g_error()
 *
 * Deprecated: 0.8.0: network_mysqld_proto_get_com_query_result()
 */
int
network_mysqld_com_query_result_track_state(network_packet G_GNUC_UNUSED *packet, network_mysqld_com_query_result_t G_GNUC_UNUSED *udata) {
 ...
 * @packet: packet
 * @query: query result
 * @use_binary_row_data: TRUE if row data has the binary encoding
 *
 * track the command execution
 *
 * Returns: -1 on error, 0 on success and done, 1 on success and need more
 */
int
network_mysqld_proto_get_com_query_result(network_packet *packet, network_mysqld_com_query_result_t *query, gboolean use_binary_row_data) {
	int is_finished = 0;
	guint8 status;
	int err = 0;
 ...
 *
 * Deprecated: 0.8.0: use network_mysqld_com_query_result_is_local_infile() 
 */
gboolean
network_mysqld_com_query_result_is_load_data(network_mysqld_com_query_result_t *udata) {
 ...
 */
gboolean
network_mysqld_com_query_result_is_local_infile(network_mysqld_com_query_result_t *udata) {
 ...
 *
 * create a new #network_mysqld_com_stmt_prepare_result_t
 */
 ...
 * @udata: a #network_mysqld_com_stmt_prepare_result_t
 *
 * free a #network_mysqld_com_stmt_prepare_result_t
 */
void
network_mysqld_com_stmt_prepare_result_free(network_mysqld_com_stmt_prepare_result_t *udata) {
	if (!udata) return;
...
/**
 * network_mysqld_proto_get_com_stmt_prepare_result:
 * @packet: a network packet
 * @udata: state data for the COM_STMT_PREPARE result
 *
 * get result of a COM_STMT_PREPARE command
 *
 * Returns: 1 if last packet is seen, 0 if more data is need, -1 on error
 */
int
network_mysqld_proto_get_com_stmt_prepare_result(
 ...
 *
 * create a new network_mysqld_com_init_db_result_t
 *
 * Returns: a #network_mysqld_com_init_db_result_t
 */
 ...
 * @com_init_db: a #network_mysqld_com_init_db_result_t
 *
 * free a #network_mysqld_com_init_db_result_t
 */
void
network_mysqld_com_init_db_result_free(network_mysqld_com_init_db_result_t *com_init_db) {
	if (com_init_db->db_name) g_string_free(com_init_db->db_name, TRUE);
 ...
 * @udata: command state data
 *
 * extract default schema name
 *
 * Returns: 0
 */
int
...
/**
 * network_mysqld_proto_get_com_init_db_result:
 * @packet: packet
 * @udata: command state
 * @con: connection
 *
 * track state the COM_INIT_DB
 *
 * Returns: -1 on error, 0 if more data needed, 1 if all packets received
 */
int
network_mysqld_proto_get_com_init_db_result(
		network_packet *packet, 
 ...
 * @packet: the current packet that is passing by
 * @con: connection
 *
 * get the result of a COM_* command
 *
 * Returns: -1 on invalid packet, 0 need more packets, 1 for the last packet 
 */
int
network_mysqld_proto_get_query_result(network_packet *packet, network_mysqld_con *con) {
	...
	case COM_CHANGE_USER: 
		...
		break;
	case COM_INIT_DB:
		is_finished = network_mysqld_proto_get_com_init_db_result(packet, con->parse.data, con);
 ...
 * @capabilities: connection capability flags
 *
 * read the field definition from @packet into @flied according to the connections @capabilties
 *
 ...
 * @chunk: (element-type GString):  list of mysql packets 
 * @fields: empty array where the fields shall be stored in
 *
 * parse the result-set packet and extract the fields
 *
 * Returns: NULL if there is no resultset, pointer to the chunk after the fields (to the EOF packet)
 */ 
 ...
 *
 * create a network_mysqld_ok_packet_t
 */
 ...
 * @ok_packet: a #network_mysqld_ok_packet_t
 *
 * free a #network_mysqld_ok_packet_t
 */
void
 ...
 * @packet: a packet
 * @ok_packet: a OK packet
 *
 * append OK packets payload to @packet
 *
 * Returns: 0
 */
int
 ...
 *
 * create a #network_mysqld_err_packet_t
 *
 * Returns: a #network_mysqld_err_packet_t
 */
 ...
 *
 * create a #network_mysqld_err_packet_t in pre 4.1 style
 *
 * Returns: a #network_mysqld_err_packet_t
 */
network_mysqld_err_packet_t *
 ...
 * @err_packet: a #network_mysqld_err_packet_t
 *
 * free a #network_mysqld_err_packet_t
 */
void
 ...
 * @packet:      network packet
 * @err_packet:  the error structure
 *
 * create a ERR packet
 *
 ...
 * create a EOF packet
 *
 * Returns: #network_mysqld_eof_packet_t
 */
 ...
 * @eof_packet: a #network_mysqld_eof_packet_t
 *
 * free a #network_mysqld_eof_packet_t
 */
void
 ...
 * @packet: network packet
 * @eof_packet: a EOF packet
 *
 * decode a EOF packet from the network packet
 */
int
 ...
 * @eof_packet: a #network_mysqld_eof_packet_t
 *
 * append @eof_packet to @packet
 *
 * Returns: 0 on success, non zero on error
 */
int
network_mysqld_proto_append_eof_packet(GString *packet, network_mysqld_eof_packet_t *eof_packet) {
	guint32 capabilities = CLIENT_PROTOCOL_41;
 ...
 *
 * create a #network_mysqld_auth_challenge
 *
 * Returns: a #network_mysqld_auth_challenge
 */
 ...
 * @shake: a #network_mysqld_auth_challenge
 *
 * free a #network_mysqld_auth_challenge
 */
void
...
/**
 * network_mysqld_auth_challenge_copy:
 * @src: a #network_mysqld_auth_challenge
 *
 ...
 */
network_mysqld_auth_challenge *
network_mysqld_auth_challenge_copy(network_mysqld_auth_challenge *src) {
 ...
 * @shake: a #network_mysqld_auth_challenge
 *
 * get a #network_mysqld_auth_challenge from @packet and store it in @shake
 *
 * Returns: 0 on success, -1 on error
 */
int
 ...
 * @server_capabilities: capabilities of the server
 *
 * create a #network_mysqld_auth_response
 *
 * Returns: a #network_mysqld_auth_response
 */
 ...
 * @auth: a #network_mysqld_auth_response
 *
 * free a #network_mysqld_auth_response
 */
void
 ...
 * @auth: a #network_mysqld_auth_response
 *
 * get a #network_mysqld_auth_response from @packet and store it in @auth
 *
 * Returns: 0 on success, -1 on error
 */
int
 ...
 * @src: a #network_mysqld_auth_response
 *
 * create a copy of @src
 *
 * Returns: a copy of @src
 */
network_mysqld_auth_response *
network_mysqld_auth_response_copy(network_mysqld_auth_response *src) {
 ...
 *
 * create a #network_mysqld_stmt_prepare_packet_t
 *
 * Returns: a #network_mysqld_stmt_prepare_packet_t
 */
...
/**
 * network_mysqld_stmt_prepare_packet_free:
 * @stmt_prepare_packet: a #stmt_prepare_packet
 *
 * free a #network_mysqld_stmt_prepare_packet_t
 */
 ...
 * @packet: network packet
 * @stmt_prepare_packet: COM_STMT_PREPARE packet
 *
 * get a #network_mysqld_stmt_prepare_packet_t from @packet
 *
 * Returns: -1 on error, 0 if done
 */
 ...
 * @stmt_prepare_packet: COM_STMT_PREPARE packet
 *
 * append a #network_mysqld_stmt_prepare_packet_t to @packet
 *
 * Returns: -1 on error, 0 if done
 */
int
network_mysqld_proto_append_stmt_prepare_packet(GString *packet, network_mysqld_stmt_prepare_packet_t *stmt_prepare_packet) {
 ...
 *
 * create a #network_mysqld_stmt_prepare_ok_packet_t
 *
 * Returns: a #network_mysqld_stmt_prepare_ok_packet_t
 */
...
/**
 * network_mysqld_stmt_prepare_ok_packet_free:
 * @stmt_prepare_ok_packet: a #network_mysqld_stmt_prepare_ok_packet_t
 *
 * free a #network_mysqld_stmt_prepare_ok_packet_t
 *
 */
void
network_mysqld_stmt_prepare_ok_packet_free(network_mysqld_stmt_prepare_ok_packet_t *stmt_prepare_ok_packet) {
 ...
 * @packet: network packet
 * @stmt_prepare_ok_packet: command tracking data
 *
 ...
 */
int
network_mysqld_proto_get_stmt_prepare_ok_packet(network_packet *packet, network_mysqld_stmt_prepare_ok_packet_t *stmt_prepare_ok_packet) {
	guint8 packet_type;
	guint16 num_columns;
	guint16 num_params;
	guint16 warnings;
 ...
 * @stmt_prepare_ok_packet: a #network_mysqld_stmt_prepare_ok_packet_t
 *
 * append a #network_mysqld_stmt_prepare_ok_packet_t to @packet
 *
 * Returns: 0 on success, non-zero on error
 */
int
network_mysqld_proto_append_stmt_prepare_ok_packet(GString *packet, network_mysqld_stmt_prepare_ok_packet_t *stmt_prepare_ok_packet) {
	int err = 0;
...
/**
 * network_mysqld_stmt_execute_packet_new:
 *
 * create a struct for a COM_STMT_EXECUTE packet
 *
 * Returns: a #network_mysqld_stmt_execute_packet_t
 */
...
/**
 * network_mysqld_stmt_execute_packet_free:
 * @stmt_execute_packet: a #network_mysqld_stmt_execute_packet_t
 *
 * free a struct for a COM_STMT_EXECUTE packet
 */
void
network_mysqld_stmt_execute_packet_free(network_mysqld_stmt_execute_packet_t *stmt_execute_packet) {
	guint i;
 ...
 */
int
network_mysqld_proto_get_stmt_execute_packet_stmt_id(network_packet *packet,
		guint32 *stmt_id) {
	guint8 packet_type;
	int err = 0;
 ...
 * @packet: network packet
 * @stmt_execute_packet: destination
 * @param_count: number of parameters that we expect to see here
 *
 ...
 *
 * append a #network_mysqld_stmt_execute_packet_t to @packet
 *
 * Returns: 0 on success, non-zero on error
 */
int
network_mysqld_proto_append_stmt_execute_packet(GString *packet,
		network_mysqld_stmt_execute_packet_t *stmt_execute_packet,
		guint param_count) {
	gsize nul_bits_len;
	GString *nul_bits;
 ...
 *
 * Returns: a #network_mysqld_resultset_row_t
 */
 ...
 * @row: a #network_mysqld_resultset_row_t
 *
 * free a struct for a COM_STMT_EXECUTE resultset row
 */
void
network_mysqld_resultset_row_free(network_mysqld_resultset_row_t *row) {
	guint i;
 ...
 */
int
network_mysqld_proto_get_binary_row(network_packet *packet, network_mysqld_proto_fielddefs_t *coldefs, network_mysqld_resultset_row_t *row) {
	int err = 0;
	guint i;
	guint nul_bytes_len;
	GString *nul_bytes;
 ...
 * @chunk: (element-type network_packet): list of network packet
 * @coldefs: column definitions
 * @row: a empty resultset row
 *
 * get the next binary row
 *
 * Returns: NULL on error, next chunk otherwise
 */
GList *
network_mysqld_proto_get_next_binary_row(GList *chunk, network_mysqld_proto_fielddefs_t *coldefs, network_mysqld_resultset_row_t *row) {
	network_packet packet;
	int err = 0;
	network_mysqld_lenenc_type lenenc_type;
	...
	err = err || network_mysqld_proto_get_binary_row(&packet, coldefs, row);
 ...
 *
 * Returns: a #network_mysqld_stmt_close_packet_t
 */
...
/**
 * network_mysqld_stmt_close_packet_free:
 * @stmt_close_packet: a #network_mysqld_stmt_close_packet_t
 *
 ...
 * @packet: a network packet
 * @stmt_close_packet: a COM_STMT_CLOSE packet
 *
 * get a COM_STMT_CLOSE packet from a network @packet
 *
 * Returns: -1 on error, 0 on success
 */
int
network_mysqld_proto_get_stmt_close_packet(network_packet *packet, network_mysqld_stmt_close_packet_t *stmt_close_packet) {
	guint8 packet_type;
	int err = 0;
 ...
 * @stmt_close_packet: a COM_STMT_CLOSE packet
 *
 * append a COM_STMT_CLOSE packet to @packet
 */
int
network_mysqld_proto_append_stmt_close_packet(GString *packet, network_mysqld_stmt_close_packet_t *stmt_close_packet) {
