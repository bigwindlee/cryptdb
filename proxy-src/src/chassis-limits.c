...
/**
 * SECTION:chassis-limits
 * @short_description: resource limits
 *
 * portable access to resource limits
 */
 ...
 * chassis_fdlimit_get:
 *
 * get the current FD limit
 *
 * Returns: fd limit or -1 on error
 */
gint64
chassis_fdlimit_get() {
#ifdef _WIN32
...
/**
 * chassis_set_fdlimit:
 * @max_files_number: max fds
 *
 * redirect the old call 
 *
 * Deprecated: 0.8.0: use chassis_fdlimit_set() instead
 */
int
chassis_set_fdlimit(int max_files_number) {
