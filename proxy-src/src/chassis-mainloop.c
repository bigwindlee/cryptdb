 ...
 * create a #chassis
 *
 * Deprecated: 0.7.0: use chassis_new() instead
 */
chassis *
chassis_init() {
	return chassis_new();
 ...
 * @location: source file location where chassis_set_shutdown_location() was called (G_STRLOC)
 *
 * set the shutdown location to @location for later logging
 */
void
 ...
 * chassis_is_shutdown:
 *
 * check if the chassis is shutting down
 *
...
/**
 * chassis_mainloop:
 * @user_data: (type chassis): the chassis
 *
 ...
 */
int
chassis_mainloop(void *user_data) {
