 ...
 * @short_description: network address handling
 *
 * supports
 * - IPv6
 * - IPv4
 ...
 * network_address_new:
 *
 * create a new netword address
 *
 * Returns: a network_address
 */
network_address *
network_address_new() {
 ...
 * @addr: a #network_address
 *
 * free a network address
 */
void
...
/**
 * network_address_reset:
 * @addr: a #network_address
 *
 * reset a #network_address into its initial, clean state
 */
void
 ...
 *
 *
 * set a IPv4 or IPv6 from a string
 *
...
/**
 * network_address_set_address_un:
 * @addr: a #network_address
 * @address: a address string
 *
 * set a unix-domain socket name from a string
 *
 * Returns: 0 on success, non zero on error
 */
static gint
...
#ifdef _WIN32
/**
 * network_address_tostring_win32:
 *
...
/**
 * network_address_tostring_inet_ntoa:
 * @addr: a #network_address
 * @dst: buffer where the address string shall be placed
 * @dst_len: in size of @dst, out bytes used for @dst
 * @gerr: a #GError or NULL
 *
 * convert a #network_address into a string using inet_ntoa()
 *
...
/**
 * network_address_tostring_inet_ntop:
 * @addr: a #network_address
 * @dst: buffer where the address string shall be placed
 * @dst_len: in size of @dst, out bytes used for @dst
 * @gerr: a #GError or NULL
 *
 * convert a #network_address into a string using inet_ntop()
 *
 * Returns: a pointer to @dst
 */
...
/**
 * network_address_tostring:
 * @addr: a #network_address
 * @dst: buffer where the address string shall be placed
 * @dst_len: in size of @dst, out bytes used for @dst
 * @gerr: a #GError or NULL
 *
 * convert a #network_address into a string
 *
 * Returns: a pointer to @dst
 */
 ...
 * @addr: a #network_address
 *
 * update the .name field of #network_address 
 *
...
/**
 * network_address_is_local:
 * @dst_addr: a #network_address
 * @src_addr: another #network_address
 *
 ...
 */
gboolean
network_address_is_local(network_address *dst_addr, network_address *src_addr) {
 ...
 * @dst: a #network_address or NULL
 * @src: a #network_address
 *
 * copy a @src to @dst
 *
 * if @dst is NULL, a new #network_address is created and @src is copied into it
 *
 * Returns: @dst
 */
network_address *
