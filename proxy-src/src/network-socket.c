 ...
 * @short_description: network socket functions
 *
 ...
 * network_socket_init:
 *
 * create a #network_socket
 *
 * Returns: a #network_socket
 * Deprecated: 0.7.0: use network_socket_new() instead
 */
network_socket *
network_socket_init() {
...
/**
 * network_socket_set_non_blocking:
 * @sock:    a socket
 *
 * portable 'set non-blocking io'
 *
 * Returns: %NETWORK_SOCKET_SUCCESS on success, %NETWORK_SOCKET_ERROR on error
 */
 ...
 */
network_socket *
network_socket_accept(network_socket *srv) {
 ...
 * 
 * Returns:        %NETWORK_SOCKET_SUCCESS on connected, %NETWORK_SOCKET_ERROR on error, %NETWORK_SOCKET_ERROR_RETRY for try again
 ...
 * 
 * Returns: %NETWORK_SOCKET_SUCCESS on connected, %NETWORK_SOCKET_ERROR on error
 *
 * See: network_address_set_address()
 */
network_socket_retval_t
...
#ifdef HAVE_WRITEV
/**
 * network_socket_write_writev:
 * @con: socket
 * @send_chunks: chunks to send. < 0 means "all"
 *
 ...
 */
static network_socket_retval_t
network_socket_write_send(network_socket *con, int send_chunks) {
	/* send the whole queue */
	GList *chunk;
 ...
 */
network_socket_retval_t
network_socket_write(network_socket *con, int send_chunks) {
	if (con->socket_type == SOCK_STREAM) {
#ifdef HAVE_WRITEV
...
/**
 * network_socket_to_read:
 * @sock: socket
 *
 * update the internal bytes-to-read
 */
network_socket_retval_t
