...
/**
 * SECTION:network-injection-lua
 * @short_description: Lua wrappers around network-injection
 *
 * Lua wrappers around network-injection
 */
 ...
 */
void
proxy_getinjectionmetatable(lua_State *L) {
