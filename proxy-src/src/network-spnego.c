...
/**
 * SECTION:network-spnego
 * @short_description: spnego 
 *
...
/**
 * network_spnego_init_token_new:
 *
 * create a #network_spnego_init_token
 *
 * Returns: a #network_spnego_init_token
 */
...
/**
 * network_spnego_init_token_free:
 * @token: a #network_spnego_init_token
 *
 * free a #network_spnego_init_token
 */
void
 ...
 *
 * create a #network_spnego_response_token
 *
 * Returns: a #network_spnego_response_token
 */
 ...
 * @token: a #network_spnego_response_token
 *
 * free a #network_spnego_response_token
 */
void
...
/**
 * network_spnego_proto_get_init_token:
 * @packet: a network packet
 * @token: a #network_spnego_init_token
 * @gerr: (allow-none): a #GError if error reporting is wanted, %NULL otherwise
 *
 * get a #network_spnego_init_token from @packet and store it in @token
 *
...
/**
 * network_spnego_proto_get_response_token:
 * @packet: a network packet
 * @token: a empty token
 * @gerr: (allow-none): a #GError if error-reporting is wanted, %NULL otherwise
 *
 * get a response token from the @packet and store it in @token
 *
 * Returns: %TRUE on success, %FALSE on error
 */
gboolean
...
/**
 * network_gssapi_proto_get_message_header:
 * @packet: a network packet
 * @oid: a empty string
 * @gerr: (allow-none): a #GError if error-reporting is wanted, %NULL otherwise
 *
 * get a message header from the @packet and set @oid
 *
 * Returns: %TRUE on success, %FALSE on error
 */
gboolean
