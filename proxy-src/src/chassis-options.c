...
/**
 * SECTION:chassis-options
 * @short_description: a _new()/_free()-able version of #GOptionEntry
 *
 * #GOptionEntry is meant to be static which isn't always the case
 */
...
*
 * set all fields of the #chassis_option_t
 *
 * See: #GOptionEntry
 */
int
...
/**
 * chassis_options_free:
 * @opts: a #chassis_options_t
 *
 * free the options
 */
void
chassis_options_free(chassis_options_t *opts) {
	GList *node;
 ...
 * @opt: a #chassis_option_t
 *
 * add a option to the option collection
 */
int
chassis_options_add_option(chassis_options_t *opts, 
		chassis_option_t *opt) {
 ...
 *
 * Returns: a #GOptionEntry
 *
 * See: chassis_options_free_g_option_entries
 */
GOptionEntry *
chassis_options_to_g_option_entries(chassis_options_t *opts) {
...
/**
 * chassis_options_free_g_option_entries:
 * @opts: options
 ...
 */
void
chassis_options_free_g_option_entries(chassis_options_t G_GNUC_UNUSED *opts, GOptionEntry *entries) {
