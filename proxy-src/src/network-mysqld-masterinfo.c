...
/**
 * SECTION:network-mysqld-masterinfo
 * @short_description: masterinfo reader/writer
 *
 * readers and writes for the MySQL masterinfo file
 */
 ...
 *
 * create a #network_mysqld_masterinfo_t
 *
 * Returns: a #network_mysqld_masterinfo_t
 */
network_mysqld_masterinfo_t *
network_mysqld_masterinfo_new(void) {
 ...
 * @info: a #network_mysqld_masterinfo_t
 *
 * free a #network_mysqld_masterinfo_t
 */
void
network_mysqld_masterinfo_free(network_mysqld_masterinfo_t *info) {
	if (!info) return;
...
static int
network_mysqld_masterinfo_get_int32(network_packet *packet, guint32 *_i) {
	GString *s;
	int err = 0;
 ...
 * @packet: a packet
 * @info: a clean #network_mysqld_masterinfo_t
 *
 ...
 */
int
network_mysqld_masterinfo_get(network_packet *packet, network_mysqld_masterinfo_t *info) {
	int err = 0;
...
static int
network_mysqld_masterinfo_append_string(GString *packet, GString *s) {
...
static int
network_mysqld_masterinfo_append_int32(GString *packet, guint32 i) {
 ...
 * @info: a #network_mysqld_masterinfo_t
 *
 * append a #network_mysqld_masterinfo_t to @packet
 *
 * Returns: 0 on success, non zero on error
 */
int
network_mysqld_masterinfo_append(GString *packet, network_mysqld_masterinfo_t *info) {
	int err = 0;
