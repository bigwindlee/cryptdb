...
/**
 * SECTION:chassis-unix-daemon
 * @short_description: UNIX daemon functions
 *
 * works across all UNIXes, but MacOS X.
 *
 * On MacOS X use launchd instead of the daemonize functions below
 */
...
/**
 * chassis_unix_proc_keepalive:
 * @child_exit_status: storage for the exit-status
 *
