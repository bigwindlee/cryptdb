...
/**
 * SECTION:network-conn-pool-lua
 * @short_description: lua wrappers around the connection pool
 *
...
/**
 * network_connection_pool_queue_getmetatable:
 * @L: a lua_State
 *
 * push metatable for a pool queue on the stack @L
 *
 * Returns: number of items pushed on the stack
 */
int
network_connection_pool_queue_getmetatable(lua_State *L) {
...
/**
 * network_connection_pool_users_getmetatable:
 * @L: a lua_State
 *
 * push metatable for the users of a pool on the stack @L
 *
 * Returns: number of items pushed on the stack
 */
int
network_connection_pool_users_getmetatable(lua_State *L) {
	static const struct luaL_reg methods[] = {
...
/**
 * network_connection_pool_getmetatable:
 * @L: a lua_State
 *
 * push metatable for a #network_connection_pool on the stack @L
 *
 * Returns: number of items pushed on the stack
 */
int
network_connection_pool_getmetatable(lua_State *L) {
	static const struct luaL_reg methods[] = {
...
/*
 * network_mysqld_con_idle_handle:
 * @event_fd: fd that fired
 * @events: events that fired for @event_fd
 * @user_data: (type network_connection_pool_entry): pool entry
 *
...
/**
 * network_connection_pool_lua_add_connection:
 * @con: a connection
 *
 ...
 */
int
network_connection_pool_lua_add_connection(network_mysqld_con *con) {
...
/**
 * network_connection_pool_lua_swap:
 * @con: connection
 * @backend_ndx: backend index
 *
 ...
 *
 * Returns: %NULL if swapping failed, the new backend on success
 */
network_socket *
network_connection_pool_lua_swap(network_mysqld_con *con, int backend_ndx) {
