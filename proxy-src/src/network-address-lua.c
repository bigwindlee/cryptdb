...
/**
 * SECTION:network-address-lua
 * @short_description: Lua wrappers around network-address
 *
 * Lua wrappers around network-address
 */
...
/**
 * network_address_lua_getmetatable:
 * @L: a lua_State
 *
 * push metatable for a #network_address on the stack @L
 *
 * Returns: number of items pushed on the stack
 */
int
network_address_lua_getmetatable(lua_State *L) {
...
/**
 * network_address_lua_push:
 * @L: a lua_State
 * @addr: a #network_address
 *
 * wrap and push #network_address on the stack @L
 *
 * Returns: number of items pushed on the stack
 */
int
network_address_lua_push(lua_State *L, network_address *addr) {
