...
/**
 * SECTION:network-mysqld-myisam
 * @short_description: myisam reader/writer
 *
 * readers and writes for the MySQL myisam files
 */
...
/**
 * network_mysqld_myisam_field_free:
 * @field: a #network_mysqld_myisam_field
 *
 * free myisam-row-format field
 */
void
network_mysqld_myisam_field_free(network_mysqld_myisam_field *field) {
	if (!field) return;
...
/**
 * network_mysqld_proto_get_myisam_field:
 ...
 */
int
network_mysqld_proto_get_myisam_field(network_packet *packet, 
		network_mysqld_myisam_field *field) {
	guint64 length;
	guint8  i8;
	guint16 i16;
...
/**
 * network_mysqld_proto_append_myisam_field:
 ...
 */
int
network_mysqld_proto_append_myisam_field(GString *packet, 
		network_mysqld_myisam_field *field) {
	guint64 length;
	guint8  i8;
	guint16 i16;
...
/**
 * network_mysqld_myisam_row_init:
 * @row: a row
 * @table: a table
 * @null_bits: bitfield of null'ed fields in this row
 * @null_bits_len: length of the null-bits in bytes (we extract it from the field-def's length)
 *
 ...
 */
int
network_mysqld_myisam_row_init(network_mysqld_myisam_row *row, 
...
/**
 * network_mysqld_proto_get_myisam_row:
 * @packet: a network packet
 * @row: a row
 *
 ...
 */
int
network_mysqld_proto_get_myisam_row(network_packet *packet, network_mysqld_myisam_row *row) {
	guint i;
...
/**
 * network_mysqld_myisam_row_free:
 * @row: a #network_mysqld_myisam_row
 *
 * free a myisam packed row
 */
void
network_mysqld_myisam_row_free(network_mysqld_myisam_row *row) {
	guint i;
