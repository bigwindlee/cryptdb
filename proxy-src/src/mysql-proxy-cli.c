...
/*
 * SECTION:mysql_proxy_cli
 * @short_description: the user-interface for the MySQL Proxy
 *
 * - command-line handling 
 * - config-file parsing
 *
 * See: chassis_mainloop()
 */
...
/*
 * chassis_frontend_free:
 * @frontend: a #chassis_frontend_t
 *
 * free the frontend of the chassis
 */
void
chassis_frontend_free(chassis_frontend_t *frontend) {
	if (!frontend) return;
 ...
 */
int
chassis_frontend_set_chassis_options(chassis_frontend_t *frontend, chassis_options_t *opts) {
