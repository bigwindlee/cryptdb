...
/**
 * SECTION:network-mysqld-table-lua
 * @short_description: Lua wrappers around network-mysqld-table
 *
 * Lua wrappers around network-mysqld-table
 */
...
/**
 * lua_mysqld_column_getmetatable:
 * @L: a lua_State
 *
 * push metatable for a #network_mysqld_column on the stack @L
 *
...
/**
 * lua_mysqld_columns_getmetatable:
 * @L: a lua_State
 *
 * push metatable for a #network_mysqld_columns on the stack @L
 *
 * Returns: number of items pushed on the stack
 */
...
/**
 * lua_mysqld_columns_push:
 * @L: a lua_State
 * @udata: a #network_mysqld_columns
 *
 * wrap and push #network_mysqld_columns on the stack @L
 *
 * Returns: number of items pushed on the stack
 */
...
/**
 * lua_mysqld_table_getmetatable:
 * @L: a lua_State
 *
 * push metatable for a #network_mysqld_table on the stack @L
 *
 * Returns: number of items pushed on the stack
 */
...
/**
 * lua_mysqld_table_push:
 * @L: a lua_State
 * @tbl: a #network_mysqld_table
 *
 * wrap and push #network_mysqld_table on the stack @L
 *
 * Returns: number of items pushed on the stack
 */
