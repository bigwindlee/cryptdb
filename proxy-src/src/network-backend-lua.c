...
/**
 * SECTION:network-backend-lua
 * @short_description: Lua wrappers around network-backend
 *
 * Lua wrappers around network-backend
 */
...
/**
 * network_backend_lua_getmetatable:
 * @L: a lua_State
 *
 * push metatable for a #network_backend on the stack @L
 *
...
/**
 * network_backends_lua_getmetatable:
 * @L: a lua_State
 *
 * push metatable for a #network_backends on the stack @L
 *
 * Returns: number of items pushed on the stack
 */
