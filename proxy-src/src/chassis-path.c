...
/**
 * SECTION:chassis-path
 * @short_description: path functions
 *
...
/**
 * chassis_resolve_path:
 * @base_dir: base directory
 * @filename: filename to be rewritten
 *
...
/**
 * chassis_path_string_is_parent_of:
 * @parent: parent path
 * @parent_len: length of @parent
 * @child: child path
 * @child_len: length of @child
 *
 ...
 */
gboolean
chassis_path_string_is_parent_of(const char *parent, gsize parent_len, const char *child, gsize child_len) {
